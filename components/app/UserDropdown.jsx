...
const UserDropdown = ({ data, uid }) => {
	...
	return (
		<div className="fixed top-0 right-0 z-50 mr-6 mt-10">
			<Menu as="div" className="lg:ring-1 lg:ring-white transition lg:ring-opacity-5 hover:bg-opacity-50 relative cursor-pointer lg:p-2 mx-4/6 rounded-lg fixed lg:bg-black lg:bg-opacity-25 lg:backdrop-blur-md inline-block lg:focus-visible:ring-2 lg:focus-visible:ring-white lg:focus-visible:ring-opacity-75">
				<div>
				...
				<MainTransition
					as={Fragment}
				>
					<Menu.Items className="absolute text-white right-0 mt-4 w-fit-content lg:w-4/6 origin-top-right rounded-md bg-black bg-opacity-25 backdrop-blur-md shadow-lg ring-1 ring-white ring-opacity-5 focus:outline-none">
						<Menu.Item>
							<button
